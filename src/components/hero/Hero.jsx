        ...
        <div className="container mx-auto pt-5 h-[750px] md:h-[100vh] md:flex-col-reverse sm:h-[780px] flex sm:flex-col-reverse sm:pt-0">
          <div className="left mt-4 md:mt-0 flex-1 flex flex-col justify-center gap-5 w-1/2 md:w-full md:py-2 sm:py-0">
            <div className="info w-fit flex flex-col items-start justify-center gap-3 sm:gap-2">
              ...
              />
              <p data-aos="fade-up" className="text-[1.1rem] font-medium w-3/4 md:w-full text-gray-600 sm:text-[.95rem]">
                I'm Nischal Acharya,
            ...
            <div data-aos="fade-up" className="buttons flex gap-5">
              ...
              <button
                  ...
                  className={`flex items-center gap-2 border text-[1rem] bg-white border-black px-7 py-2 sm:px-6 rounded-lg font-bold ${
                      downloadState === 'complete' ? 'text-green-700' : 'hover:text-violet-700'
                  }`}
                  aria-label="Download Nischal's CV"
              >
          ...
          <div className="flex justify-center items-center h-screen">
            <div className="relative h-4/5 md:h-3/4 w-full md:w-3/4 lg:w-2/3 xl:w-1/2 rounded-md overflow-hidden md:order-2">
              <img
                  data-aos="fade-right"
